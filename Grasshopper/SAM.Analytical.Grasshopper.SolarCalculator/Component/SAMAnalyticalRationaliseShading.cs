    ...
    public class SAMAnalyticalRationaliseShading : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Outputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "designSummary", NickName = "designSummary", Description = "The engineering answer in one line: what to build, how big, what it blocks, what it keeps, and the wanted solar it costs", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
