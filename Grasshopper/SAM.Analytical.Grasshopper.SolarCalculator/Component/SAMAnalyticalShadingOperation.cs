    ...
    public class SAMAnalyticalShadingOperation : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Outputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "controlledDirectSolarIntercepted", NickName = "controlledDirectSolarIntercepted", Description = "Direct solar the device intercepted while deployed [kWh]", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "canopyAttributedEnergy", NickName = "canopyAttributedEnergy", Description = "First-hit energy credited to the CANOPY while deployed [kWh]", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "valanceAttributedEnergy", NickName = "valanceAttributedEnergy", Description = "First-hit energy credited to the VALANCE while deployed [kWh].\nATTRIBUTED energy in the current geometry - NOT a claim about the same device with the valance removed", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
